...
function CheckAnswersButton({ onClick, label = "Check Answers" }) {
  return (
    <button
      onClick={onClick}
      style={{
...
function ScoreFeedback({ score, total, onRetry, message }) {
  return (
    <div
      style={{
        marginTop: 16,
...
function AnswerFeedback({ isCorrect, answer, explanation }) {
  return (
    <div
      style={{
        marginTop: 10,
